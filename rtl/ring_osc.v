//=============================================================================
// ring_osc.v — Parameterizable ring oscillator for Xilinx 7-series FPGAs
//
...
// add a timing exception in constraints (see nexys_a7.xdc).
//=============================================================================
module ring_osc #(
    parameter STAGES = 3          // Must be odd (3, 5, 7, 9, 11 …)
)(
    output wire osc_out
);
